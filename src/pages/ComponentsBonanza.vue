...
const list = ref([
  { id: 0, title: "Expanded", text: "Elements like accordion that have an hidden element, require an `aria-expanded` property to be set" },
  ...
  { id: 4, title: "Add accessibility in your process", text: "Having accessibility as part of your process will greatly help you improve your skills and make accessible applications." }
])
...
<template>
  ...
  <h2>Top 5 mistakes when developing SPA</h2>
  <template 
